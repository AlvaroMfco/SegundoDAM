...
public class EjemploNIO2Path { 
	...
	public static void main(String[] args) { 
		...
		/*Indicamos el número de elementos, nombres, que tiene la ruta absoluta.*/ 
		...
		/*La carpeta 0 de la ruta absoluta, es la carpeta que tenemos más próxima  
		 * a la unidad de disco duro del ordenador, que es Users en nuestro ejemplo. 
		 * El método subpath(0, 2) toma como subruta las carpetas de posición  
		 * 0 y la de posición 2-1. 
		 * El método subpath(4, 6) sacará como subruta las carpetas de posición  
		 * 4 y 6-1*/ 
